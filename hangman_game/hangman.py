...
def hangman(secret_word):
    ...
    * Har round ke baar, user ko uska guess kiya hua partial word
    ...
    user_difficulty_choice = raw_input(
        "Aap abhi kitni difficulty par yeh game khelna chahte ho?\na)\tEasy\nb)\tMedium\nc)\tHard\n\nApni choice a, b, ya c ki terms mei batayein\n")

    total_lives =  get_chance = 8
    ...
    if user_difficulty_choice == "a":
        ...
        print ("Aapki choice invalid hai.\nGame madiam mode mei start kar rahe hai")
    elif user_difficulty_choice == "c":
        print ("Aapki choice invalid hai.\nGame hard mode mei start kar  hai")

    if user_difficulty_choice == "b":
        total_lives = get_chance = 6
        images_selection_list_indices = [0, 2, 3, 5, 6, 7]

    elif user_difficulty_choice == "c":
        total_lives = get_chance = 4
    ...
    while i < get_chance:
        ...
        if letter in secret_word:
            ...
            print IMAGES[8-get_chance]

            print "your lives:-", get_chance
            print ""
            letters_guessed.append(letter)
            get_chance -= 1
    print secret_word
